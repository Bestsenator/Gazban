...
class HeadArea extends User {
  ...
  factory HeadArea.fromMap(Map<String, dynamic> data) => HeadArea(
  ...
  factory HeadArea.fromJson(String data) {
    return HeadArea.fromMap(json.decode(data) as Map<String, dynamic>);
  }
